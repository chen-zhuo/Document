...
```
    ...
    Ctrl+N  ---  新建（新建空白文件或空白浏览器窗口）
    
    Ctrl+O  ---  打开（剪切当前所选内容）
    
    Ctrl+P  ---  打印（打印当前文件）
	
    Ctrl+Q  ---  清楚（清除选择文本的字体格式）
...
*[Typora](https://www.typora.io/)* 是一款轻便简洁的 ***Markdown* 编辑器**。下
...
代码块支持多种编程语言，点击代码块在右下方 `选择语言` 中填写语言或者直接 \`\`\`语言，即可对应不同的主题。
...
![QQ截图20191114212636](image/QQ截图20191114212636.png)

**快间公式**

均方误差方程式源代码：

![QQ截图20191114212520](image/QQ截图20191114212520.png)

!> *Github* 上的文档不支持公式块即 *LaTeX* 数学公式，展示数学公式最好使用网页加载 *JS* 库来展示。
